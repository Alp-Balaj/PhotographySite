    ...
    <body>
        <div class="login-box">
            ...
            <form method="post" name="form">
                ...
                <div class="user-box"><input type="password" placeholder="Confirm Password" id="ConfirmPassword" name="password_2">  
                ...
                <div class="par"><p>Already have an account?<a class="login" href="Login.php"> Log-in</a> here</p></div>
            </form>
        </div>
